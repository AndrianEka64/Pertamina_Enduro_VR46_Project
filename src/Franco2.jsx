...
const Franco = () => {
    return (
        <div className="relative md:flex">
            <img src="morbido.png" className="h-96 md:h-8/12 z-20" alt="" />
            <div className="mt-34 ml-48 mb-32">
                <div className="absolute top-4 md:top-12 right-0 md:right-18 z-30">
                    <img src="21.png" className="md:float-left h-24 md:h-26 lg:h-32 mr-5 mt-2" alt="" />
                    <h1 className="hidden md:block text-2xl md:text-4xl lg:text-6xl md:font-extrabold md:leading-tight md:text-black md:dark:text-white">FRANCO MORBIDELLI</h1>
                </div>
            ...
            <div className="flex justify-center pt-34 md:absolute md:-bottom-16 md:left-12 z-30">
