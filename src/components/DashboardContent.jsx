...
const Stats = ({ value, label, icon }) => {
    return (
        <div className="md:h-30 md:w-64 rounded-xl bg-[#0B0F1A] shadow-xl/20 hover:scale-105 transition duration-300 flex flex-col items-center justify-center hover:shadow-lg dark:shadow-white p-5">
            <div className="flex">
