const FooterDashboard = () => {
    return (
        <>
            <footer className="border-t border-white text-white py-4 px-3 mt-16">
                <div className="container mx-auto flex flex-wrap items-center justify-between">
                    <div className="w-full md:w-1/2 md:text-center md:mb-0 mb-8">
                        <p className="text-xs text-gray-400 md:text-sm">&copy; 2024 Pertamina Enduro VR46. All Rights Reserved</p>
                    </div>
                    <div className="w-full md:w-1/2 md:text-center md:mb-0 mb-8">
